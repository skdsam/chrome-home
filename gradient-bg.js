// gradient-bg.js - WebGL Shader-based Interactive Gradient Background
// Based on Three.js with touch/mouse interaction
...
class WebGLGradientApp {
    constructor(container) {
        ...
        this.renderer.domElement.id = "webgl-gradient";
    ...
    dispose() {
        ...
        if (this.gradientBackground.mesh) {
            ...
            this.scene.remove(this.gradientBackground.mesh);
        }
    ...
    setColors(color1Hex, color2Hex) {
        ...
        if (c1 && c2) {
            ...
            u.uColor3.value.set(c1.r, c1.g, c1.b);
            ...
            u.uDarkNavy.value.set(c2.r, c2.g, c2.b);
...
window.WebGLGradientApp = WebGLGradientApp;